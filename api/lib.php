...
{
    return [
        // — до аддона: блайнды растут до 75/150, 6 уровней × 30 мин = 3 часа —
        [10, 20, 0, 30, 0, null],
        [20, 40, 0, 30, 0, null],
        [30, 60, 0, 30, 0, null],
        [40, 80, 0, 30, 0, null],
        [50, 100, 0, 30, 0, null],
        [75, 150, 0, 30, 0, null],
        // — перерыв + аддон (после блайндов 75/150, ~3 часа) —
        [0, 0, 0, 15, 1, 'Перерыв + аддон'],
        // — после аддона: с анте, темп выше —
        [100, 200, 200, 20, 0, null],
        [150, 300, 300, 20, 0, null],
        [200, 400, 400, 20, 0, null],
