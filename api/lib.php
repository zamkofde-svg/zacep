...
/**
 * Структура блайндов «Классика»: стартовый стек 5000 (500 bb), старт 5/10,
 * перерыв + аддон после 50/100, с 500/1000 — игра на вылет (фризаут).
 * Все уровни по 15 минут, без анте. [sb, bb, ante, minutes, is_break, title]
 */
function default_levels(): array
{
    return [
        ...
        [300, 600, 0, 15, 0, null],
        [400, 800, 0, 15, 0, null],
        // — с этого уровня игра на вылет (без ре-энтри) —
