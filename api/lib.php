...
function blind_structures(): array
{
    return [
        ...
        // Структура Данил v2 — стек 3000, старт 10/20, без анте.
        // После 75/150 — перерыв, дальше игра на вылет (без ре-энтри).
        'danil' => [
            'label' => 'Данил v2',
            'stack' => 3000,
            'levels' => [
                ...
                [50, 100, 0, 15, 0, null],
                [75, 150, 0, 15, 0, null],
                [0, 0, 0, 15, 1, 'Перерыв · дальше игра на вылет'],
                [100, 200, 0, 15, 0, null],
                [150, 300, 0, 15, 0, null],
                [200, 400, 0, 15, 0, null],
                [300, 600, 0, 15, 0, null],
                [500, 1000, 0, 15, 0, null],
                [700, 1400, 0, 15, 0, null],
                [1000, 2000, 0, 15, 0, null],
                [1500, 3000, 0, 15, 0, null],
                [2000, 4000, 0, 15, 0, null],
                [3000, 6000, 0, 15, 0, null],
            ],
        ],
